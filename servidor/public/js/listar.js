...
/*
            <table width='20%' class='buscador'>
                <tr>
                  <td style='padding-right: 10px'>
                    <input type='text' id='buscadorGrave' onkeyup='buscarGrave()' placeholder='Introduce termino a buscar...'>
                  </td>
                </tr>
              </table>
*/